...
public class WebContainer extends Applet
    ...
    public void reset() {
        ...
        // Cheng: this particle tail length might be used when painting
    ...
    public void init() {
        ...
        // Cheng: other things below are basically all about frontend listener and adjustable parameters
